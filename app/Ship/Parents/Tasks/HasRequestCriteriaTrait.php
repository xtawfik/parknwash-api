...
use App\Ship\Criterias\Eloquent\FilterCriteria;
use App\Ship\Criterias\Eloquent\YearFilterCriteria;
...
trait HasRequestCriteriaTrait
{
  ...
  public function addRequestCriteria($repository = null)
  {
    ...
    $validatedRepository->pushCriteria(app(FilterCriteria::class));
    $validatedRepository->pushCriteria(app(YearFilterCriteria::class));
  }
